 ...
 * - запомнить, что в коллекциях могут быть значения null, приводящие к NullPointerException;<br/>
 ...
 * - (дополнительно) научиться избегать повторений кода при реализации близких алгоритмов.<br/>
 * <p/>
 * ЗАДАНИЕ<br/>
