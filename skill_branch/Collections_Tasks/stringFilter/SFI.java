 ...
 */
public class SFI implements StringFilter{
    ...
    public Iterator<String> getStringsStartingWith(String begin) {
        ...
        if ((iterStart == null) || !iterStart.hasNext()) {
...
//
//        Iterator<String> it;
//        it = s.getStringsStartingWith("a");
//        System.out.println(it);
//        it = s.getStringsStartingWith("");
//        System.out.println(it);
